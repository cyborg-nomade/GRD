...
namespace CPTM.GRD.Persistence.Migrations
{
    ...
    [Migration("20220815150808_RemoveUselessAndamentoField")]
    partial class RemoveUselessAndamentoField
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CPTM.GRD.Domain.Proposicoes.Proposicao", b =>
                {
                    ...
                    b.Property<string>("ProtocoloExpediente")
                        .IsRequired()
                        .HasColumnType("NVARCHAR2(2000)");
            ...
            modelBuilder.Entity("CPTM.GRD.Domain.Proposicoes.Children.Voto", b =>
                {
                    b.HasOne("CPTM.GRD.Domain.AccessControl.User", "Participante")
                        .WithMany()
