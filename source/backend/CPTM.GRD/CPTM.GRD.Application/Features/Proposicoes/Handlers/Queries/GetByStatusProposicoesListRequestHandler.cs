...
public class GetByStatusProposicoesListRequestHandler : IRequestHandler<GetByStatusProposicoesListRequest, List<ProposicaoListDto>>
{
    ...
    public async Task<List<ProposicaoListDto>> Handle(GetByStatusProposicoesListRequest request, CancellationToken cancellationToken)
    {
        var proposicoes = await _proposicaoRepository.GetByStatus(request.Status);
